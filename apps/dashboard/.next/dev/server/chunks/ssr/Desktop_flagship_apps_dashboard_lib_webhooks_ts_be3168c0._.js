module.exports = [
"[project]/Desktop/flagship/apps/dashboard/lib/webhooks.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function logWebhookDelivery(delivery) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$flagship$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$flagship$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$flagship$2f$apps$2f$dashboard$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'webhook_deliveries'), {
            ...
            deliveredAt: delivery.status === 'success' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$flagship$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serverTimestamp"])() : null
        });
    } catch (error) {
...
async function triggerWebhooks(projectId, event, data) {
    const { collection: firestoreCollection, query, where, getDocs } = await __turbopack_context__.A("[project]/Desktop/flagship/node_modules/firebase/firestore/dist/index.mjs [app-ssr] (ecmascript, async loader)");
    try {
        // Get all enabled webhooks for this project that listen to this event
        const webhooksQuery = query(firestoreCollection(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$flagship$2f$apps$2f$dashboard$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], 'webhooks'), where('projectId', '==', projectId), where('enabled', '==', true), where('events', 'array-contains', event));
...
//# sourceMappingURL=Desktop_flagship_apps_dashboard_lib_webhooks_ts_be3168c0._.js.map